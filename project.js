		...
		var o = {
			...
			fireworksAni: function (e, t, n, o) {
				for (var c = 0; c < t; c++) {
					...
					a.scale = .3 + .5 * Math.random(), a.position = n,
						a.color = cc.color(this.fireColorArr[this.returnRanNum(0, this.fireColorArr.length - 1)]), e.addChild(a, 88);
			...
			fireObjAni: function (e, t, n, o) {
				...
				var i = cc.misc.degreesToRadians(t),
					...
					s = n / o;
				e.runAction(cc.sequence(cc.delayTime(c),
					cc.jumpBy(s, cc.v2(1.5 * r.x, 0), n, 1), cc.removeSelf(!0)))
			},
			bombObjAni: function (e, t, n, o, c, a) {
				...
				var i = cc.misc.degreesToRadians(t),
					...
					l = c ? 0 : e.scale,
					u = a ? 0 : 255;
				e.runAction(cc.sequence(cc.spawn(cc.scaleTo(s + .1, l),
	...
	AutoDestroy: [function (e, t, n) {
		...
		var a = e("../Common/PoolManager"),
			...
			l = function (e) {
				...
				}, c([s(cc.Label)], t.prototype, "label", void 0), c([s], t.prototype, "text", void 0),
					t = c([r], t)
			}(cc.Component);
		n.default = l, cc._RF.pop()
	}, {
		...
		var a = cc._decorator,
			...
			l = function (e) {
				...
				return o(t, e), n = t, t.prototype.onLoad = function () {
					...
					null == this.playerData && (this.playerData = new s, this.playerData.isFirstPlay = !0,
						this.playerData.score = 0, this.playerData.highScore = 0, this.playerData.goldCount = 0,
	...
	DynamicLoad: [function (e, t, n) {
		...
		var a = cc._decorator,
			...
			s = function (e) {
				function t() {
					var t = null !== e && e.apply(this, arguments) || this;
					return t.adsbutton = [], t.adsbutton2 = [],
						t.caidia = [], t.fllows = [], t.fruit = [], t.guozhiZ = [], t.guozhiL = [],
				...
				}, t.Instance = null, c([r(cc.SpriteFrame)], t.prototype, "adsbutton", void 0),
					c([r(cc.SpriteFrame)], t.prototype, "adsbutton2", void 0), c([r(cc.SpriteFrame)],
					t.prototype, "caidia", void 0), c([r(cc.SpriteFrame)], t.prototype, "fllows", void 0),
					c([r(cc.SpriteFrame)], t.prototype, "fruit", void 0), c([r(cc.SpriteFrame)],
					t.prototype, "guozhiZ", void 0), c([r(cc.SpriteFrame)], t.prototype, "guozhiL", void 0),
					c([r(cc.SpriteFrame)], t.prototype, "fruitL", void 0), t = n = c([i], t)
			}(cc.Component);
		n.default = s, cc._RF.pop()
	}, {}],
	EffectCenter: [function (e, t, n) {
		...
		var o = this && this.__extends || function () {
			...
			c = this && this.__decorate || function (e, t, n, o) {
				...
				if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) i = Reflect.decorate(e, t, n, o);
					...
					for (var r = e.length - 1; r >= 0; r--) (c = e[r])
		...
		var a = e("../Common/Utils"),
			...
			f = function (e) {
				function t() {
					var t = null !== e && e.apply(this, arguments) || this;
					return t.bgEffect = null, t.downEffectPartiParent = null,
						t.upEffectPartiParent = null, t.uiEffectParent = null,
						t.cameraNode = null, t.fireLightNode = null, t.effectTxtParent = null,
						t.bgEffectParent = null, t
				}
				...
				return o(t, e), n = t, t.prototype.onLoad = function () {
					...
					t.position = e, t.scale = .2,
						t.runAction(cc.sequence(cc.scaleTo(.3, 1.2),
							cc.fadeOut(.3))), t.children[0].runAction(cc.spawn(cc.moveBy(.5, -65, 65),
						cc.fadeOut(.6))), t.children[1].runAction(cc.spawn(cc.moveBy(.5, 65, -65),
						cc.fadeOut(.6))), t.children[2].runAction(cc.spawn(cc.moveBy(.5, -65, -65),
						cc.fadeOut(.6))), t.children[3].runAction(cc.spawn(cc.moveBy(.5, 65, 65),
						cc.fadeOut(.6)))
					...
					for (var t = 0; t < e.length; t++) {
						...
						for (var o = 0; o < 40; o++) {
							...
							c.runAction(cc.sequence(cc.spawn(cc.bezierTo(1, [r, p, cc.v2(u, d)]).easing(cc.easeCircleActionOut()),
								cc.moveBy(2.8, 0, 1.2 * -cc.winSize.height * a.default.Random(.8, 1.2)).easing(cc.easeCubicActionIn()),
								cc.moveBy(2.8, a.default.Random(0, -300) * n, 0),
								cc.rotateBy(2, a.default.Random(360, 720) * (2 * Math.round(Math.random()) - 1)),
								cc.sequence(cc.moveBy(2 * (.1 * Math.random() + .3),
									(25 * Math.random() + 25) * (2 * Math.round(Math.random()) - 1), 0),
									cc.moveBy(2 * (.1 * Math.random() + .3),
										(25 * Math.random() + 25) * (2 * Math.round(Math.random()) - 1), 0),
									cc.moveBy(2 * (.1 * Math.random() + .3),
										(25 * Math.random() + 25) * (2 * Math.round(Math.random()) - 1), 0))),
								cc.callFunc(function (e, t) {
					...
					for (var t = a.default.RandomInteger(20, 26), n = 0; n < t; n++) {
						...
						o.node.position.add(s.mul(a.default.Random(0, 30)));
						var u = a.default.Random(.3, .36);
						o.node.runAction(cc.sequence(cc.delayTime(u * a.default.Random(.1, .3)),
							cc.scaleTo(.8 * u, a.default.Random(.1, .3)))),
							o.node.runAction(cc.sequence(cc.moveBy(u, s.mul(l)).easing(cc.easeCubicActionOut()),
					...
					for (var t = function (t) {
						...
						o.node.parent = n.bgEffectParent, o.node.position = e, o.Reset(),
							o.SetSprite(r.default.Instance.GetSpriteFrame("star"), cc.v2(32, 32)), o.node.color = new cc.Color(254, 236, 180);
					...
					for (var t = 0; t < 3; t++) {
						...
						o.Reset(), n.position = e, n.scale = 0,
							o.SetSprite(r.default.Instance.GetSpriteFrame("ball"),
								cc.v2(20, 20)),
							o.node.color = (new cc.Color).fromHEX("#AD0909"),
							n.setContentSize(a.default.RandomInteger(16, 18),
								a.default.RandomInteger(16, 18)),
							n.runAction(cc.sequence(cc.delayTime(.5 * t),
								cc.delayTime(.5), cc.scaleTo(.1, 0))),
							n.runAction(cc.sequence(cc.delayTime(.4 * t),
								cc.scaleTo(.3, 1),
								cc.moveBy(.6, cc.v2(0, -180)), cc.callFunc(function () {
						}, n)))
					}
					...
					for (var n = a.default.RandomInteger(32, 43), o = 0; o < n; o++) {
						...
						c.parent = this.downEffectPartiParent, c.position = e, c.opacity = 0,
							c.setContentSize(120, 120), c.scale = a.default.Random(.3, 1.3);
						var r = cc.v2(0, 1);
			...
			p = function (e) {
				function t() {
					...
					return t.clickMask = null,
						t.failedUiBox = null,
						t.di = null, t.levelTxt = null,
						t.guan = null, t.continueTip = null,
						t.scoreLabel = null, t.highScoreNode = null,
						t.highScore = null, t.highScoreLabel = null,
						t.resultTxt = null, t.overTxt = null,
						t.moreGameBtn = null, t.reStartBtn = null,
						t.failedBoxPos = cc.v2(0, -500),
						t.standardScore = 0, t.canClick = !1,
						t.bgMask = null, t.bencichengji = null,
						t.bencichengjiarr = [], t.gengduoyouxi = null,
						t.gengduoyouxiarr = [], t.adsButton2 = null,
						t.bannerButton = null, t
				}
				...
				return o(t, e), n = t, t.prototype.onLoad = function () {
					...
					this.scheduleOnce(function () {
						r.default.Instance.HideScorePanel(), n.levelTxt.string = r.default.Instance.level.toString(), n.scoreLabel.string = s.default.score.toString(), n.highScoreLabel.string = t, n.resultTxt.string = n.GetContentByScore(e), n.overTxt.string = "\u5f53\u524d\u5173\u5361\u5df2\u5b8c\u6210" + Math.floor(r.default.Instance.nowYQ / r.default.Instance.passlevelYQ * 100) + "%", n.canClick = !1, n.levelTxt.string = e, n.bgMask.runAction(cc.fadeTo(.36, 150)), n.scheduleOnce(function () {
							i.default.CenteredUi(10, this.di, this.levelTxt.node, this.guan), this.failedUiBox.y = cc.winSize.height / 2 + this.failedUiBox.height / 2, this.failedUiBox.runAction(cc.sequence(cc.moveTo(.36, this.failedBoxPos).easing(cc.easeBackOut()), cc.callFunc(function () {
								this.clickMask.on(cc.Node.EventType.TOUCH_START, this.OnClickCloseMask, this), this.moreGameBtn.on(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.continueTip.opacity = 0, this.continueTip.runAction(cc.repeatForever(cc.sequence(cc.fadeIn(.05), cc.delayTime(.05), cc.fadeOut(.05)))), this.canClick = !0
							}, this)))
						}, 0)
					}, .5)
					...
					this.canClick
					&& 0 == cc.find("Canvas/uiEffectPanel").childrenCount && a.default.Instance.RestartGame()
				}, t.prototype.OnClickMoreGame = function () {
					this.canClick
					&& (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1))), this.scheduleOnce(function () {
			...
			m = function (e) {
				...
				return o(t, e), t.prototype.onLoad = function () {
					...
					0 == this.wallColl && (d.default.Instance.Play(5, !1, 1),
						...
						c == r && (reverseLevelUp ? (c > border && r > border) :
							(c < border && r < border)) ? (this.pengzhuangCount += 1,
							0 == t.node.getComponent("fruitData").getNumber()
							&& (a.default.score += this.fruitNumber + (extraScore ? extraScore : 1), // 改分数
							...
							&& (a.default.score += this.fruitNumber + (extraScore ? extraScore : 1), // 改分数
								...
								s.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[reverseLevelUp ? 0 : 10],
									s.parent = c, s.position = cc.v2(0), d.default.Instance.Play(4, !1, 1),
									i.default.Instance.ribbonEffect(cc.v2(0, 0)),
									c.runAction(cc.sequence(cc.spawn(cc.jumpBy(1, 0, 0, 300, 1),
										cc.scaleTo(1, 1)),
										cc.delayTime(0.1),
										cc.spawn(cc.moveTo(1, cc.v2(0, 500)), cc.scaleTo(1, 0)),
										cc.callFunc(function () {
											a.default.score += 100, u.default.Instance.SetScoreTween(a.default.score),
												e.active = !1,
												a.default.playerTouch = !0, c.destroy()
										}))), n.node.active = !1, t.node.active = !1, n.node.destroy(), t.node.destroy()
							}).start()))
						console.warn("currentScore:" + a.default.score)
					}
					...
					r.default.Spawn("boom", cc.find("Canvas/upEffectParent")).position =
						s.default.convetOtherNodeSpaceAR(this.node, cc.find("Canvas/upEffectParent"))
				}, t.prototype.clockEoilffect = function (e, t) {
					for (var n = 0; n < 3; n++) setTimeout(function () {
						var t = r.default.Spawn("star", cc.find("Canvas/upEffectParent"));
						t.position = e.position, t.scale = .3,
							t.runAction(cc.sequence(cc.scaleTo(.5, 1.1), cc.fadeOut(.5)))
					}, 300 * n)
				}, t.prototype.addScoreEffect = function () {
					var e = r.default.Spawn("add1", cc.find("Canvas/mainGameUi"));
					e.position = cc.find("Canvas/mainGameUi")
						.children[0].position.add(cc.v2(0, 50)),
						e.runAction(cc.spawn(cc.moveBy(.5, 0, 50),
							cc.fadeOut(.5)))
		...
		cc.Class({
			...
			onLoad: function () {
				...
				o ? o < c.gameScore && (this.setHisSocre(c.gameScore),
					o = c.gameScore) : (this.setHisSocre(c.gameScore), o = n),
